...
import 'package:flutterrun/application/order/order_notifier.dart';
...
class _CartPageState extends ConsumerState<CartPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: cartState.isEmpty ? Center(child: Text('Add some product to cart')): ValueListenableBuilder<Box<CartItem>>(
                    ...
                    child: ListView.separated(
                      ...
                      separatorBuilder: (c, i){
                        ...
                        itemBuilder: (context, index){
                          ...
                          return Row(
                            children: [
                              Image.network(cart.imageUrl, height: 120.h,) ,
                              Spacer(),
                              Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text('Rs.${cart.price} X ${cart.quantity}'),
                                  ),
                                  Row(
                                    children: [
                                      OutlinedButton(onPressed: (){
                                        ref.read(cartProvider.notifier).singleAddCart(cart);
                                      ...
                                      OutlinedButton(onPressed: (){
                                        ref.read(cartProvider.notifier).singleRemoveCart(cart);
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                       ...
                       final  response = await   ref.read(orderProvider).orderAdd(
                              amount: totalShow,
